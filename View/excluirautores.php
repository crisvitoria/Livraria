...
<body>
    ...
    <form method="post" class="w3-container">
        ...
        <br>
        <label class="w3-text-red"><b>E-mail</b></label>
        <input class="w3-input w3-border w3-light-grey" type="email" name="email">
        <br>
        <label class="w3-text-red"><b>Data de Nascimento</b></label>
        ...
        if ($result && mysqli_num_rows($result) > 0)
        {
            ...
            while ($row = mysqli_fetch_assoc($result))
            {
                ...
                echo "<tr>
                        ...
                        <td><a class='w3-button w3-red w3-round-large' onclick='excluirautor($id)' role='button'>Excluir</a></td>
                    </tr>";
            }
            ...
            {
                echo "<a href='editarautores.php?pagina=$i' class='w3-button w3-circle w3-red'>$i</a> ";
            }
            echo "</div></div>";
    ...
    <script>
        ...
        {
            let resultado = confirm("Deseja realmente excluir o autor?");

            if (resultado) 
            {
                window.location.href = "excluirautoresscript.php?id=" + id;
            }
        }
    </script>
</body>
